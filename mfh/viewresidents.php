...
?>
 ...
 <div class="small-container single-product" id="singleproduct">
     <div class="wrapper">
     <a class = "navlink_button" href="mfh.php">Back</a>
     </div>
    <div class="row">
   

            <div class="col-2">
            <button class = "nav_button float-left" id="prev">Prev</button>
                <button class = "nav_button float-right" id="next">Next</button>
